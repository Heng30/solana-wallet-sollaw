...
#define PRODUCT_NAME           "sollet" // 产品名称
...
#define INTERNAL_NAME          "sollet.exe"
#define FILE_DESCRIPTION       "sollet is a Solana wallet"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "sollet.exe"    // 原始文件名
