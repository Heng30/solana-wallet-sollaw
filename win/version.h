...
#define PRODUCT_NAME           "sollaw" // 产品名称
...
#define INTERNAL_NAME          "sollaw.exe"
#define FILE_DESCRIPTION       "sollaw is a Solana wallet"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "sollaw.exe"    // 原始文件名
